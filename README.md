...
* Anchoring on-chain Bitcoin/USd futures price to reality on the ground - solved with [Probabilistic Altruistic Delivery](https://github.com/sidepit/dexchain/blob/main/README.md#probabilistic-altruistic-delivery) 
* KYC / AML / MTL / Legalities associated with *final mile" p2p USD cash to bitcoin - solved with [The Dex Experiment](https://github.com/sidepit/dexchain/blob/main/README.md#the-dex-experiment)
